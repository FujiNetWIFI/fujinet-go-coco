...
/**
 * Keeps the CoCo emulator and the in-process FujiNet runtime alive as a
...
class EmulatorSessionService : Service() {
    ...
    private fun buildNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("FujiNet Go CoCo")
            .setContentText("Color Computer emulator and FujiNet are running")
    ...
    companion object {
        const val ACTION_SHUTDOWN = "online.fujinet.go.coco.action.SHUTDOWN"
