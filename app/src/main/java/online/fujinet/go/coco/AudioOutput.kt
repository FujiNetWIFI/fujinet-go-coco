...
/**
 * Streams XRoar's audio to an AudioTrack as a "game" audio source.
 *
 * The XRoar ao_android module pushes interleaved stereo 44100 Hz samples into a
 * native ring each frame; a high-priority feeder thread pulls *full* blocks via
 * the blocking [EmulatorNative.nativeFillAudio] and writes them with
